  ...
  return (
    <div className="min-h-screen bg-black text-white pt-28 px-4 md:px-6">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <a 
          href="https://github.com/core-ctrl/Rushes" 
          target="_blank" 
          rel="noopener noreferrer"
          className="flex flex-col sm:flex-row items-start sm:items-center justify-between bg-gradient-to-r from-neutral-900 to-neutral-800 border border-white/10 rounded-2xl p-5 mb-10 hover:border-white/20 transition-all group gap-4 shadow-lg shadow-black/50"
        >
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 flex-shrink-0 rounded-full bg-white/5 flex items-center justify-center text-white group-hover:scale-110 transition-transform">
            ...
            <div>
              <h3 className="font-bold text-lg text-white">Support Rushes</h3>
              <p className="text-sm text-neutral-400">If you enjoy using this project, please star our repository on GitHub!</p>
            </div>
          </div>
          <button className="px-5 py-2.5 bg-white/10 hover:bg-white/20 text-white text-sm font-bold rounded-xl transition-colors border border-white/5 flex-shrink-0">
            Star Repo ⭐️
          </button>
        </a>
